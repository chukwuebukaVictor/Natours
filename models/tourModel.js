...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      // validate: [validator.isAlpha, 'Tour name must be a character'],
    },
    slug: String,
    duration: {
      type: Number,
    ...
    ratingsAverage: {
      ...
      set: (val) => Math.round(val * 10) / 10, //4.666666*10, 46.6666 Math.round, 47 / 10, 4.7
    },
    ratingsQuantity: {
      type: Number,
      default: 0,
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (val) {
          //this keyword points to current document on new doc creation
